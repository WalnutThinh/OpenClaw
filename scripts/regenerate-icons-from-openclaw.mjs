/**
 * Windows branding (optional): copy `resources/openclaw-logo.ico` → `build/icon.ico` and rasterize PNGs.
 * Otherwise: rasterize `src/renderer/src/assets/openclaw-color.svg` into PNGs + multi-size `build/icon.ico`.
 */
import fs from 'fs'
